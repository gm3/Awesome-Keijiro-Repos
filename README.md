...
Thank you so much Keijiro for all of your amazing work! 

---
Here is a curated list of cool Keijiro repo, check out all of the repos above

## Volumetric Unity Tings
...
## Camera Effects
* https://github.com/keijiro/HexBokeh
...
* https://github.com/keijiro/KvantWig

## Scans
* https://github.com/keijiro/ThreeDScans

## Filters
* https://github.com/gm3/PSlicer
...
## 2d Transpform Position Scroller
* https://github.com/keijiro/ScrollerTest/blob/master/Assets/Scroller.cs

## Sandbox
* https://github.com/keijiro/ManyCubes/blob/master/Assets/CubeCluster.cs

## TEXT Type
* https://github.com/keijiro/TextAnimation

## Projection Mapping Test
* https://github.com/keijiro/UnityCubes

## GPU OBject Array Animator
...
### Credits
Shout out to https://M3Org.com, SithLord, Jin and Humbletim helping put this awesome list together! Plese submit a pull request to add to the list! source: https://www.keijiro.tokyo/
